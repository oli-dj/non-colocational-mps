...
%The idea with this example is to be able to condition to ALL data during
%simulation.                    

SDG = NaN(5,5,2); %Soft Data Grid

% 1st soft data point "pseudo hard"
SDG(5,5,1) = 0.999;
SDG(5,5,2) = 1-SDG(5,5,1);

% 2nd soft data point "mildly informative"
SDG(5,1,1) = 0.3;
SDG(5,1,2) = 1-SDG(5,1,1);

%3rd data point "informationless"
SDG(1,4,1) = 0.5;
SDG(1,4,2) = 0.5;

% 4th soft data point "mildly informative"
SDG(3,3,1) = 0.7;
SDG(3,3,2) = 1-SDG(3,3,1);

% 5th soft data point "strongly informative"
SDG(2,2,1) = 0.9;
SDG(2,2,2) = 1-SDG(2,2,1);
